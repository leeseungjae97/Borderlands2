...
public:
	...
	void SetEmis(int _Idx, bool _bEmis) { m_Const.arrTexEmis[_Idx] = _bEmis; }
	...
	void SetPerlinNoise(bool _bTrue) { m_Const.arrInt[1] = _bTrue; }
	void SetBilboard(bool _bTrue) { m_Const.arrInt[2] = _bTrue; }
