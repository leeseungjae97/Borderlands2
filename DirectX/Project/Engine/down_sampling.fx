#ifndef DOWN_SAMPLING_FX
#define DOWN_SAMPLING_FX
...
[numthreads(8, 8, 1)]
void CS_ThresholdAndDownsample(uint3 groupID : SV_GroupID, uint3 groupThreadID : SV_GroupThreadID, uint groupIndex : SV_GroupIndex, uint3 dispatchID : SV_DispatchThreadID)
{
